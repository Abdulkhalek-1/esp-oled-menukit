...
// ----- Action callbacks --------------------------------------------------
static void act_brightness(void *ctx)
{
    (void)ctx;
    menu_toast("Brightness +", 600);
}
static void act_contrast(void *ctx)
{
    (void)ctx;
    menu_toast("Contrast +", 600);
}
static void act_reset(void *ctx)
{
    (void)ctx;
    menu_toast("Reset!", 600);
}
static void act_version(void *ctx)
{
    (void)ctx;
    menu_toast("v0.1", 600);
}
static void act_uptime(void *ctx)
{
    (void)ctx;
    menu_toast("Up 0m12s", 600);
}
static void act_scan(void *ctx)
{
    (void)ctx;
    menu_toast("Scanning", 600);
}
static void act_connect(void *ctx)
{
    (void)ctx;
    menu_toast("Connect", 600);
}
static void act_status(void *ctx)
{
    (void)ctx;
    menu_toast("Online", 600);
}
static void act_pair(void *ctx)
{
    (void)ctx;
    menu_toast("Pairing", 600);
}
static void act_devices(void *ctx)
{
    (void)ctx;
    menu_toast("Devices", 600);
}
